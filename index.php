...
<body class="body">
    ...
    <div class="section0">
        ...
        <div class="section4">
            <div class="SLeft">
                <input type="text" placeholder="ระบุคำค้น" name="keyword">
                <button name="act" onclick="window.location='index.php?search=ส่งคำค้นไปจ้า'">Search</button>
            </div>
            <div class="SRight">
                <?php $Typedetail = $db_handle->Textquery("SELECT * FROM PRODUCT_TYPE;") ?>
                <select name="Stype" onchange="window.location='index.php?search=ส่งประเภทไปจ้า'">
